	...
	public WindowManual()
	{
		...
		listaNoduri = new Vector<Node>();
		 ...
		 JButton Orientat = new JButton("Sortare ");
			...
			JButton Orientat1 = new JButton("Radacina");
		Orientat1.setBackground(Color.white);
		Orientat1.setBounds(500,70,150,40);
		Orientat1.setFont(new Font("Arial", Font.BOLD, 15));
		add(Orientat1);
		Orientat1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			//	if(listaNoduri.size()>0)
			}
		});
